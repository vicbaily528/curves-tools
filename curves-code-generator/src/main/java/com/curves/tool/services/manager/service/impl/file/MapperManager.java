...
public class MapperManager implements IGeneratorObserver, IGeneratorDisplay {

    private GeneratorManager generatorManager;

    public MapperManager(GeneratorManager generatorManager) {
    ...
    public void display() {
        try {
            ...
            FreemarkerUtils.generateFile("mapper.flt", CFileHelper.getCodeFile(filePath, tableDO.getClassName(), "Mapper.java"), dataMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    @Override
    public void init() {
        filePath = CFileHelper.getServicesPath(projectDTO, "mapper");
