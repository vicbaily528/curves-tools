...
public class ControllerManager implements IGeneratorObserver, IGeneratorDisplay {

    private GeneratorManager generatorManager;

    public ControllerManager(GeneratorManager generatorManager) {
    ...
    public void display() {
        try {
            ...
            FreemarkerUtils.generateFile("controller.flt", CFileHelper.getCodeFile(filePath, tableDO.getClassName(), "Controller.java"), dataMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    @Override
    public void init() {
        filePath = CFileHelper.getServicesPath(projectDTO, "controller");
