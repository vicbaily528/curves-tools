...
public class EntityManager implements IGeneratorObserver, IGeneratorDisplay {

    private GeneratorManager generatorManager;

    public EntityManager(GeneratorManager generatorManager) {
    ...
    public void display() {
        try {
            ...
            FreemarkerUtils.generateFile("entity.flt", CFileHelper.getCodeFile(filePath, tableDO.getClassName(), "Entity.java"), dataMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    @Override
    public void init() {
        filePath = CFileHelper.getServicesPath(projectDTO, "pojo/entity");
