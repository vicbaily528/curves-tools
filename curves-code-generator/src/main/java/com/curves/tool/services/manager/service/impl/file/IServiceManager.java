...
public class IServiceManager implements IGeneratorObserver, IGeneratorDisplay {

    private GeneratorManager generatorManager;

    public IServiceManager(GeneratorManager generatorManager) {
    ...
    public void display() {
        try {
            ...
            FreemarkerUtils.generateFile("iservice.flt", CFileHelper.getCodeFile(filePath, "I" + tableDO.getClassName(), "Service.java"), dataMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    @Override
    public void init() {
        filePath = CFileHelper.getServicesPath(projectDTO, "service");
