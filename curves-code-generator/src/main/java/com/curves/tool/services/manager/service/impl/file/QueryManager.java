...
public class QueryManager implements IGeneratorObserver, IGeneratorDisplay {

    private GeneratorManager generatorManager;

    public QueryManager(GeneratorManager generatorManager) {
    ...
    public void display() {
        try {
            ...
            FreemarkerUtils.generateFile("query.flt", CFileHelper.getCodeFile(filePath, tableDO.getClassName(), "Query.java"), dataMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    @Override
    public void init() {
        filePath = CFileHelper.getServicesPath(projectDTO, "pojo/query");
