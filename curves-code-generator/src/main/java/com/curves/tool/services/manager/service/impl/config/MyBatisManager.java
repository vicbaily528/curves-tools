...
public class MyBatisManager implements IGeneratorObserver, IGeneratorDisplay {

    private GeneratorManager generatorManager;

    public MyBatisManager(GeneratorManager generatorManager) {
    ...
    public void display() {
        try {
            ...
            FreemarkerUtils.generateFile("mybatis-config.flt", CFileHelper.getCodeFile(filePath, "mybatis-config", ".xml"), dataMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
