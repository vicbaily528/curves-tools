...
public class ServiceManager  implements IGeneratorObserver, IGeneratorDisplay {

    private GeneratorManager generatorManager;

    public ServiceManager(GeneratorManager generatorManager) {
    ...
    public void display() {
        try {
            ...
            FreemarkerUtils.generateFile("service.flt", CFileHelper.getCodeFile(filePath, tableDO.getClassName(), "ServiceImpl.java"), dataMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    @Override
    public void init() {
        filePath = CFileHelper.getServicesPath(projectDTO, "service/impl");
